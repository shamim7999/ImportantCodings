...
type hobbies[] string /// -----------> I added for understanding
...
func main() {
	users := []user{ // #2
		{"inanc", "1234", nil, nil},
		{"god", "42", permissions{"admin": true}, nil},
		{"devil", "66", permissions{"write": true, "read" : true}, hobbies{"Reading", "Writing", "Coding", "etc."}},
	}
